...
const ImageHeader = dynamic(() => import("./ImageHeader"));
const BottomHeader = ({
  selectedIdText,
  setText,
  text,
    ...
    <React.Fragment>
      ...
      {selectedIdText !== null && (
        <React.Fragment>
          <Grid
            container
            className="py-2 px-3 position-fixed z-3 bg-white  border-bottom  selected-image-top"
            style={{ top: "65.6px" }}
          >
      ...
      {selectedId !== null && (
        <React.Fragment>
          <Grid
            container
            className="py-2 px-3 position-fixed z-3 bg-white  border-bottom  selected-image-top selected-image-top-image"
            style={{ top: "65.6px" }}
          >
            <Grid item xs={12} className="my-auto">
              <ImageHeader
