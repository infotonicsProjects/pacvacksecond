...
const Sidebar = ({ setSelectedEdit, selectedEdit }) => {
  return (
    <div
      className="d-flex flex-column flex-shrink-0 text-black"
      style={{ width: "4.5rem" }}
    >
      <ul className="nav nav-pills nav-flush flex-column mb-auto text-center align-items-center padding-li-x-1 button-flex">
        <li>
          <button
            onClick={() =>
              selectedEdit === "text"
      ...
      <div className="dropdown border-top">
        {selectedEdit ? (
          <button
            ...
            className={
              selectedEdit === "background"
                ? "nav-link py-3 bg-dark-subtle px-2 rounded btn font-size"
                : "nav-link py-3 btn"
            }
