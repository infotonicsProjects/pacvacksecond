...
import SelectedLogos from "../../design2/SelectedLogos";
...
const Back = ({
  ...
  return (
    <div
      ...
      className={
        imageside.back === 1
          ? "border border-2 border-dark position-fixed d-flex justify-content-center align-items-center flex-column  rounded overflow-hidden right-section-back mobile-border-none bg-grey-dekstop bg-white"
