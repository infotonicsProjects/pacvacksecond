          ...
          <div className="row align-items-center">
            <div className="col-auto">
              <h1 className="fs-5 color-900 mt-1 mb-0">
                {" "}
                Payment transactions table Account Add
              </h1>
          ...
          <div className="row g-3">
            <div className="col-12">
              <div className="card">
                ...
                <div className="card-body" id="hide">
                  <div className="row g-3">
                    ...
                    <div class="col-lg-4 col-md-6">
                      <label class="form-label">Gateway details</label>
                      <input
                        type="text"
                        class="form-control form-control-lg"
                        placeholder="Enter here"
              ...
              <div className="card">
                ...
                <div className="card-body" id="hide">
                  <div className="row g-3">
                    {/* <a href={urls + "samplefiles/csv/paymenttransactionstable.csv"}><span>Click here to download sample CSV file for this form</span></a> */}

                    <div id="unhide" style={{ display: "none" }}>
                      {/* <CsvUpload csv_url={urls + "payment_transactions_table"} /> */}
                    </div>
                  </div>
                </div>
              </div>
