...
export default function Table() {
  ...
  const tableData = CustomeHookTable("shipping_information_table", setLoading);
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <Pagination heading="Shipping Information" page={"Table"} />
                  ...
                  <div className="card">
                    <div className="card-header">
                      <h6 className="card-title mb-0">
                        Shipping Information Account Manager
                      </h6>
