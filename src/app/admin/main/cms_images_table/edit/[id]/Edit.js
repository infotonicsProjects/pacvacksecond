...
export default function Edit({ params }) {
  ...
  // const [created_at, setCreated_at] = useState(cms_images_table.created_at);
  // const [updated_at, setUpdated_at] = useState(cms_images_table.updated_at);
  const [imagePreview, setImagePreview] = useState([
    ...cms_images_table?.imagePreview,
  ]);
  const [pageId, setPageId] = useState("");

  const [alt_text, setAlt_text] = useState(cms_images_table?.alt_text);
                      ...
                      <div className="row g-3">
                        {/* <div className="col-lg-4 col-md-6">
                                                    ...
                                                    <input type="text" className="form-control form-control-lg" placeholder="Enter here"
                                                        defaultValue={cms_images_table.created_at}
                                                ...
                                                <div className="col-lg-4 col-md-6">
                                                    ...
                                                    <input type="text" className="form-control form-control-lg" placeholder="Enter here"
                                                        defaultValue={cms_images_table.updated_at}
                                                        onChange={e => setUpdated_at(e.target.value)}
                                                    />
                                                </div> */}
                        {/* <div className="col-lg-4 col-md-6">
                                                    <label className="form-label">Page_id</label>
                                                    <input type="text" className="form-control form-control-lg" placeholder="Enter here"
                                                        defaultValue={cms_images_table.page_id}
                        ...
                        <div className="col-lg-4 col-md-6">
                          ...
                          {/* <input type="text" className="form-control form-control-lg" placeholder="Enter here"
                                                        defaultValue={cms_images_table?.image_url}
                        ...
                        <div className="col-lg-4 col-md-6">
                          ...
                          <input
                            ...
                            defaultValue={cms_images_table?.alt_text}
                        ...
                        <div class="col-lg-4 col-md-6">
                          ...
                          <input
                            ...
                            placeholder="Enter here"
                            defaultValue={cms_images_table?.title}
                        ...
                        <div class="col-lg-4 col-md-6">
                          ...
                          <input
                            ...
                            class="form-control form-control-lg"
                            placeholder="Enter here"
                            defaultValue={cms_images_table?.author}
                        ...
                        <div class="col-lg-4 col-md-6">
                          ...
                          <input
                            ...
                            class="form-control form-control-lg"
                            placeholder="Enter here"
                            defaultValue={cms_images_table?.seo_data}
