...
export default function Table() {
  ...
  const tableData = CustomeHookTable("promotions_discounts_table", setLoading);
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <Pagination heading="Promotions Discount" page={"Table"} />
                  ...
                  <div className="card">
                    <div className="card-header">
                      <h6 className="card-title mb-0">
                        Promotions Discount Account Manager
                      </h6>
