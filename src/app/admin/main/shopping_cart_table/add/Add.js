...
export default function Add() {
  ...
  const sumbitForm = async () => {
    ...
    const res = await PostData("shopping_cart_table", setLoading, signal, data);
    if (res) {
          ...
          <div className="row align-items-center">
            <div className="col-auto">
              <h1 className="fs-5 color-900 mt-1 mb-0">
                {" "}
                Shopping cart table Account Add
              </h1>
          ...
          <div className="row g-3">
            <div className="col-12">
              ...
              <div className="card">
                ...
                <div className="card-body" id="hide">
                  <div className="row g-3">
                    {/* <a href={urls + "samplefiles/csv/shoppingcarttable.csv"}><span>Click here to download sample CSV file for this form</span></a> */}

                    <div id="unhide" style={{ display: "none" }}>
                      {/* <CsvUpload csv_url={urls + "shopping_cart_table"} /> */}
                    </div>
                  </div>
                </div>
              </div>
