...
export default function Table() {
  ...
  const tableData = CustomeHookTable("file_manager", setLoading);
  return (
    <>
      {loading ? (
        <LoadingComponet />
        ...
        <>
          <Pagination heading="File Manager" page={"Table"} />
                ...
                <div className="col-xl-12">
                  <div className="card">
                    <div className="card-header">
                      <h6 className="card-title mb-0">File Account Manager</h6>
