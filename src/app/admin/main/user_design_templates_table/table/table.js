...
export default function Table() {
  ...
  const tableData = CustomeHookTable("user_design_templates_table", setLoading);
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <Pagination heading="User Design Templates" page={"Table"} />
                  ...
                  <div className="card">
                    <div className="card-header">
                      <h6 className="card-title mb-0">
                        User Design Templates Account Manager
                      </h6>
